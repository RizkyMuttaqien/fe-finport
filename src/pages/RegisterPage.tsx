        ...
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-900 text-white p-6 h-screen">
                <form onSubmit={handleSubmit} className="bg-gray-800  p-10 rounded-2xl w-full max-w-md shadow-lg flex flex-col gap-6">
                    ...
                    <button className="bg-purple-500 text-white py-3 rounded-xl mt-4 font-semibold hover:bg-purple-600 transition-all shadow-md hover:shadow-lg cursor-pointer">Sign Up</button>

                    <p className="text-center text-gray-400 mt-4 text-sm font-medium">
                        Already have an account?{" "}
                        <span onClick={() => navigate("/login")} className="text-purple-500 ms-1 font-semibold hover:text-purple-400 hover:underline transition-colors cursor-pointer">
                            Sign In
                        </span>
                    </p>
                </form>
